    ...
    try {
        ...
        if (result.error) {
            ...
            valueContain.innerHTML = `
                <h3>Current Time Power Usage Prediction:</h3>
                <p><strong>Value:</strong> ${result.value.toFixed(2)} MW</p>
            `;
        }
    } catch (error) {
    ...
    try {
        ...
        if (result.error) {
            ...
            resultContainer.innerHTML = `
                <h3>Get Past Load Data:</h3>
                <p><strong>Date and Time:</strong> ${month}-${day} ${time}</p>
                <p><strong>Prediction:</strong> ${result.prediction.toFixed(2)} MW</p>
            `;
        }
